  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-3 left-3 z-[60] flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface-raised text-content-muted opacity-60 shadow-md transition-opacity hover:text-content hover:opacity-100"
      >
