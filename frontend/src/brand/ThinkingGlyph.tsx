...
const NODES: [number, number][] = [
  [6.3, 35.6], [28.9, 40.8], [36.2, 88.8], [6.9, 85.0], [10.0, 37.5],
  [68.5, 51.0], [41.8, 46.2], [47.3, 41.6], [38.3, 90.1], [37.7, 37.5],
  [0.1, 12.8], [49.2, 3.9], [89.4, 31.2], [89.4, 84.4], [67.0, 91.1], [67.0, 37.9],
];
