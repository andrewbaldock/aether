...
export const ICON_VOCABULARY = [
  ...
  "Wrench",
  "Shield",
  // Expanded set (2026-06-22): animals, food, media, books/time, places, more
  // tech/objects/symbols. Kept 1:1 with the frontend VOCABULARY map; off-list
  // model picks are dropped to null in generateTitle, so both lists must agree.
  "Cat",
  "Skull",
  "Book",
  "Balloon",
  ...
  "Diamond",
  "ThumbsUp",
  // Expanded set (2026-07-01): sports/games (bowling had NO ball-sport fit and
  // landed on Swords), more animals, food, transport, tools, home. Every name
  // verified against the installed lucide-react. Keep 1:1 with the frontend
  // VOCABULARY map.
  "Volleyball",
  "Goal",
  "Dices",
